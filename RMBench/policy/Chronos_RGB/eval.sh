...
ckpt_setting="${3:-rgb_head_ee16}"
seed="${4:-42}"
physical_gpu_id="${5:-0}"
test_num="${6:-5}"
ckpt_path="${7:-policy/Chronos_RGB/checkpoints/${task_name}/EE_16/last.ckpt}"
scaler_path="${8:-policy/Chronos_RGB/scaler_${task_name}_ee_rgb.pth}"
